...
# Tải hình ảnh nền
layer1_level1_img = pygame.image.load("img/background1/layer1.png").convert_alpha()
layer2_level1_img = pygame.image.load("img/background1/layer2.png").convert_alpha()
layer3_level1_img = pygame.image.load("img/background1/layer3.png").convert_alpha()
layer4_level1_img = pygame.image.load("img/background1/layer4.png").convert_alpha()

layer1_level2_img = pygame.image.load("img/background2/layer1.png").convert_alpha()
layer2_level2_img = pygame.image.load("img/background2/layer2.png").convert_alpha()
layer3_level2_img = pygame.image.load("img/background2/layer3.png").convert_alpha()
layer4_level2_img = pygame.image.load("img/background2/layer4.png").convert_alpha()

stage_sceneries = {
    "level1": {
        "layer1": layer1_level1_img,
        "layer2": layer2_level1_img,
        "layer3": layer3_level1_img,
        "layer4": layer4_level1_img
    },
    "level2": {
        "layer1": layer1_level2_img,
        "layer2": layer2_level2_img,
        "layer3": layer3_level2_img,
        "layer4": layer4_level2_img
    }
}
...
def render_stage_scenery():
    ...
    width = bg_set["layer1"].get_width()
    for x in range(5):
        game_window.blit(bg_set["layer1"], ((x * width) - bg_scroll * 0.5, 0))
        game_window.blit(bg_set["layer2"], ((x * width) - bg_scroll * 0.6, screen_height - bg_set["layer2"].get_height() - 300))
        game_window.blit(bg_set["layer3"], ((x * width) - bg_scroll * 0.7, screen_height - bg_set["layer3"].get_height() - 150))
        game_window.blit(bg_set["layer4"], ((x * width) - bg_scroll * 0.8, screen_height - bg_set["layer4"].get_height()))
...
while run:
    ...
    if start_intro:
        ...
        label_x = (exit_rect.x + (exit_rect.width  - label_width) // 2) - 15
        label_y = start_y
        draw_text(label_text, small_font, white, label_x, label_y)
        name_x = (exit_rect.x + (exit_rect.width  - name_width) // 2) - 15
